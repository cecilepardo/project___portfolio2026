...
const Contact: React.FC<ContactProps> = ({ theme }) => {
	...
	return (
		...
		<div
			className={`contact-container ${theme === "dark" ? "theme-dark" : "theme-light"}`}
		>
					...
					<form className={styles.form}>
						...
						<div className={styles.checkboxGroup}>
							...
							<label htmlFor="rgpdConsent">
								En cochant cette case, j'accepte que mes données soient traitées
								dans le cadre de ma demande de contact.
							</label>
						</div>
